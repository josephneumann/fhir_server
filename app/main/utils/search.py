...
from app.main.utils.type_validation import *
...
def search_support_is_valid(support):
    """
    Validation function for models search support dictionary
    :param support:
...
def parse_fhir_search(args, base, model_support=None):
    ...
    for arg in args:
        ...
        if search_key == '_sort' and input_value:
            ...
            # If exists, create a models search spec with sort data
