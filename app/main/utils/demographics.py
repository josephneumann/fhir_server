...
def validate_race(race):
    ...
    Value set url = http://hl7.org/models/us/core/ValueSet/omb-race-category
...
def validate_ethnicity(ethnicity):
    ...
    Uses OMB Ethnicity Category FHIR ValueSet http://hl7.org/models/us/core/ValueSet/omb-ethnicity-category
...
def random_ethnicity():
    ...
    http://hl7.org/models/us/core/ValueSet/omb-ethnicity-category
...
def validate_marital_status(status):
    ...
    Value set: Expansion based on http://hl7.org/models/v3/MaritalStatus version 2016-11-11
...
def random_marital_status():
    ...
    Status codeset http://hl7.org/models/v3/MaritalStatus
