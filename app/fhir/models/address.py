...
class Address(db.Model):
    ...
    def fhir(self):
        """
        Returns models-client Address model object associated with SQLAlchemy Instance
        If no models-client object is initialized, one is created and stored in protected attrib _fhir
        :return:
            models-client Address object matching SQLAlchemy ORM object instance
        """
    ...
    def fhir(self, fhir_obj):
        ...
        Validates object is models-client model Address object
        :param fhir_obj:
            A models-client Address model object instance
        :return:
            None
        """
    ...
    def create_fhir_object(self):
        ...
        Create a models-client.model.address.Adress object and stores to the self.models attribute
...
class AddressAPI:
    ...
    used in conjuction with person or non-person routes associated with the address.  The address is manipulated
