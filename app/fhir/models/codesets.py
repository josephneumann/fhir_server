...
class CodeSystem(db.Model):
    ...
    def set_attributes_from_fhir(self):
        ...
        contained within self.data and self.models.  Used to initialize new objects, or update existing objects."""
    ...
    def fhir(self):
        """
        Accesses existing models model object, or initializes new models object and returns it
        :return:
    ...
    @fhir.setter
    def fhir(self, value):
        raise AttributeError('Property models is read-only.')
    ...
    def dump_fhir_json(self):
        return self.data  # same as self.models.as_json()
