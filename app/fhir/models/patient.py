...
from app.main.utils.demographics import *
from flask import url_for, render_template
from app.main.utils.general import json_serial
from app.fhir.models.address import Address, AddressSchema
from app.fhir.models.email_address import EmailAddress, EmailAddressSchema
from app.fhir.models.phone_number import PhoneNumber, PhoneNumberSchema
from app.fhir.models.codesets import ValueSet
from app.main.models.extensions import BaseExtension
from fhirclient.models import patient as fhir_patient, meta, codeableconcept, coding, extension, identifier, narrative
from app.main.utils.fhir_utils import fhir_gen_humanname, fhir_gen_datetime
from app.main.utils.demographics import ethnicity_dict
...
class Patient(db.Model):
    ...
    def get_url(self):
        ...
        """
        return url_for('fhir.patient_read', patientid=self.id, _external=True)
    ...
    def previous_version_url(self):
        ...
        #     return url_for('fhir.get_user_version', userid=self.id, version_number=self.version_number - 1,
        #                    _external=True)
        # else:
        #     return None
    ...
    def fhir(self):
        """
        Returns models-client Patient model object associated with SQLAlchemy Instance
        If no models-client object is initialized, one is created and stored in protected attrib _fhir
        :return:
            models-client Patient object matching SQLAlchemy ORM object instance
        """
    ...
    def fhir(self, fhir_obj):
        ...
        Validates object is models-client model Patient object
        :param fhir_obj:
            A models-client Patient model object instance
        :return:
            None
        """
    ...
    def create_fhir_object(self):
        ...
        if ins.persistent:
            ...
            fhir_meta.profile = ['http://hl7.org/models/us/core/StructureDefinition/us-core-patient']
            ...
            mrn_coding.system = 'http://hl7.org/models/v2/0203'
            mrn_coding.code = 'MR'
            ...
            if self.ssn:
                ...
                id_ssn.use = 'usual'
                id_ssn.system = 'http://hl7.org/models/sid/us-ssn'
                ...
                ssn_coding.system = 'http://hl7.org/models/v2/0203'
                ssn_coding.code = 'SS'
            ...
            if self.marital_status:
                ...
                marital_status_url = 'http://hl7.org/models/ValueSet/marital-status'
            ...
            if self.race:
                ...
                ext_race.url = 'http://hl7.org/models/StructureDefinition/us-core-race'
                race_url = 'http://hl7.org/models/us/core/ValueSet/omb-race-category'
            ...
            if self.ethnicity:
                ...
                ext_ethnicity.url = 'http://hl7.org/models/us/core/StructureDefinition/us-core-ethnicity'
                ...
                coding_ethnicity.system = 'http://hl7.org/models/us/core/ValueSet/omb-ethnicity-category'
            ...
            if self.sex:
                ...
                ext_birth_sex.url = 'http://hl7.org/models/us/core/StructureDefinition/us-core-birthsex'
            ...
            if self.preferred_language:
                ...
                fhir_lang_url = 'http://hl7.org/models/ValueSet/languages'
            ...
            xhtml = render_template('patient.html', fhir_patient=fhir_pt, patient=self)
