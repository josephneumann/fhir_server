...
from app.main.utils.demographics import validate_phone, validate_contact_type, format_phone
...
class PhoneNumber(db.Model):
    ...
    def fhir(self):
        """
        Returns models-client ContactPoint model object associated with SQLAlchemy Instance
        If no models-client object is initialized, one is created and stored in protected attrib _fhir
        :return:
            models-client ContactPoint object matching SQLAlchemy ORM object instance
        """
    ...
    def fhir(self, fhir_obj):
        ...
        Validates object is models-client model ContactPoint object
        :param fhir_obj:
            A models-client ContactPOint model object instance
        :return:
            None
        """
