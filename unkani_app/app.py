# -*- coding: utf-8 -*-
"""The unkani_app module, containing the unkani_app factory function"""
import os
from flask import Flask
from flask_sslify import SSLify
from sqlalchemy import or_, and_, any_
from config import config
from unkani_app.extensions import db, login_manager, ma, redis, principal, session, migrate
from unkani_app import api_v1, commands

from unkani_app.models.user import User, UserAPI
from unkani_app.models.role import Role
from unkani_app.models.fhir.patient import Patient
from unkani_app.models.app_permission import AppPermission, role_app_permission
from unkani_app.models.fhir.address import Address, AddressAPI
from unkani_app.models.fhir.email_address import EmailAddress, EmailAddressAPI
from unkani_app.models.app_group import AppGroup, user_app_group
from unkani_app.models.fhir.phone_number import PhoneNumber, PhoneNumberAPI
from unkani_app.models.fhir.organization import Organization
from unkani_app.models.source_data import SourceData
from unkani_app.models.fhir.codesets import CodeSystem, ValueSet
