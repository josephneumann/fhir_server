...
from unkani_app.models.app_group import AppGroup
from unkani_app.models.role import Role
from unkani_app.models.user import User, UserAPI, UserVersionSchema
from unkani_app.security import *
...
from unkani_app.api_v1.errors.exceptions import *
from unkani_app.api_v1.utils.rate_limit import rate_limit
from unkani_app.api_v1.utils.pagination import paginate_query, filter_ops, register_arg_error
...
def update_user(userid):
    ...
    # Check unkani_app permission for logged in user to update the given user
