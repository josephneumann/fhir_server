...
from unkani_app.api_v1.authentication import token_auth
from unkani_app.api_v1.errors.user_errors import *
from unkani_app.api_v1.utils.rate_limit import rate_limit
from unkani_app.api_v1.utils.etag import etag
from unkani_app.api_v1.utils.bundle import create_bundle
from unkani_app.api_v1.utils.search import fhir_search
from unkani_app.api_v1.utils.requests import enforce_fhir_mimetype_charset
from unkani_app.models.fhir.patient import Patient
from unkani_app.models.fhir.address import Address
from unkani_app.models.fhir.email_address import EmailAddress
from unkani_app.models.fhir.phone_number import PhoneNumber


@api_bp.route('/fhir/Patient/<patientid>', methods=['GET'])
@token_auth.login_required
@enforce_fhir_mimetype_charset
@rate_limit(limit=5, period=15)
@etag
def patient_read(patientid):
    """
...
@api_bp.route('/fhir/Patient/<patientid>', methods=['PUT'])
@token_auth.login_required
@enforce_fhir_mimetype_charset
@rate_limit(limit=5, period=15)
@etag
...
@api_bp.route('/fhir/Patient/<patientid>', methods=['DELETE'])
@token_auth.login_required
@enforce_fhir_mimetype_charset
@rate_limit(limit=5, period=15)
...
@api_bp.route('/fhir/Patient/<patientid>/_history/<int:vid>', methods=['GET'])
@token_auth.login_required
@enforce_fhir_mimetype_charset
@rate_limit(limit=5, period=15)
@etag
def patient_vread(patientid, vid):
    pt = Patient.query.get_or_404(ident=patientid)
