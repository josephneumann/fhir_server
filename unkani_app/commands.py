...
from unkani_app.utils.demographics import random_demographics
from unkani_app.models.fhir.codesets import process_fhir_codeset, get_fhir_codeset
from unkani_app.models.user import User
from unkani_app.models.role import Role
from unkani_app.models.fhir.patient import Patient
from unkani_app.models.app_permission import AppPermission
...
def deploy():
    """Command line utility to complete deployment tasks:
     ...
     4) Initialize unkani_app permisions, user roles and admin user
    ...
    if click.confirm(text='Are you sure you want to proceed?', default=False, show_default=True):
        ...
        print()
        print("Initializing unkani_app permissions...")
